...
;; [Base/Step] Setting up system [main], k = 2. 
...
;; Querying base with actlit [%actlit_10] (3 candidates). 
...
(assert
 ...
 (not
  (and
   ...
   (= main.usr.y@2 (not main.res.init_flag@2))
   main.usr.y@2))))
;; Success 
...
(get-value
 (main.res.init_flag@2 main.usr.y@2 main.res.init_flag@1 main.usr.y@1))
;; ((main.res.init_flag@2 false) 
;;     (main.usr.y@2 true) 
...
;; Querying base with actlit [%actlit_11] (2 candidates). 
...
(assert
 (=>
 %actlit_11
 (not (and (= main.usr.y@2 (not main.res.init_flag@2)) main.usr.y@2))))
;; Success 
...
;; Querying base with actlit [%actlit_12] (2 candidates). 
...
(assert
 ...
 (not
  (and
   (= main.res.init_flag@2 (not main.usr.y@2))
...
;; Asserting transition relation at [3]. 

(assert (and (= main.usr.y@3 true) (not main.res.init_flag@3)))
;; Success 

;; Asserting invariants at [3]. 

(assert (= main.usr.y@3 main.usr.y@2))
;; Success 

(assert (= main.res.init_flag@3 (not main.usr.y@2)))
;; Success 

(assert (= (not main.res.init_flag@3) main.usr.y@2))
;; Success 

(assert (= (not main.usr.y@3) (not main.usr.y@2)))
;; Success 
